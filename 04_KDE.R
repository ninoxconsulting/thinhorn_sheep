...
st_write(all_poly, path("02_draft_outputs", "sheep_yr_polygons_bbmm30.gpkg"), append = TRUE)
...
st_crs(all_poly) <- 3005
st_write(all_poly, path("02_draft_outputs", "sheep_month_yr_polygons_bbmm30.gpkg"), append = FALSE)
...
st_crs(all_poly) <- 3005
st_write(all_poly, path("02_draft_outputs", "sheep_winter_yr_polygons_bbmm30.gpkg"), append = FALSE)
...
st_crs(all_poly) <- 3005
st_write(all_poly, path("02_draft_outputs", "sheep_summer_yr_polygons_bbmm30.gpkg"), append = FALSE)


############################################################################
## Part 4: Rut season 
## Oct / november 20th - November 20th 
...
jstart <- Julianday(ymd("2024-10-20")) #294
jend <- Julianday(ymd("2024-11-20"))   #325
...
st_crs(all_poly) <- 3005
st_write(all_poly, path("02_draft_outputs", "sheep_rut_yr_polygons_bbmm30.gpkg"), append = FALSE)
